...
public class RPCServer {
    ...
    private RPCServer() {
        try {
            ...
            InetSocketAddress address = new InetSocketAddress(8686);
    ...
    private void remoteHandMethod(ByteBuffer buff, SelectionKey sk, SocketChannel sc)
        ...
        String message = new String(data, 0, postion);
